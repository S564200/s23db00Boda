...
router.get('/', function (req, res) {
  res.render('index', { title: 'Jackets App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Jackets App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Jackets App Login', user: req.user });
});
